...
class TestExportAssets(unittest.TestCase):
    ...
    @patch('main.asset_v1.OutputConfig')
    @patch('main.asset_v1.ExportAssetsRequest')
    def test_export_assets_no_asset_or_content_types(self, mock_request, mock_output_config, mock_asset_v1):
        mock_client = MagicMock()
        mock_asset_v1.AssetServiceClient.return_value = mock_client
    ...
    @patch('main.asset_v1.OutputConfig')
    @patch('main.asset_v1.ExportAssetsRequest')
    def test_export_assets_invalid_content_type(self, mock_request, mock_output_config, mock_asset_v1):
        mock_client = MagicMock()
        mock_asset_v1.AssetServiceClient.return_value = mock_client
    ...
    @patch('main.asset_v1.OutputConfig')
    @patch('main.asset_v1.ExportAssetsRequest')
    def test_export_assets_sdk_exception(self, mock_request, mock_output_config, mock_asset_v1):
        mock_client = MagicMock()
        ...
        self.assertEqual(response, ("Failed to export content type RESOURCE. Error: SDK error", 500))
